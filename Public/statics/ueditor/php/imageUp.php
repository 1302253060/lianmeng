<?php
    ...
    $imgSavePathConfig = array_keys($globalConfig[ 'imageSavePath' ]);
    ...
    $info = $up->getFileInfo();
    //@todo liuzhen05 区分环境
    //$info['url'] = 'http://webimg.br.baidu.com/app_store/' . $info['name'];
    $info['url'] = $globalConfig[ 'imageSavePath' ][$path] . $info['name'];
